...
power.BACI(change, change.type="M", nt, nc, parst, parsc, distribution="normal", test="P", alpha=0.05, nsims=1000)
#change.type M dictates PERCENTAGE change of post-treatment mean relative to pre-treatment mean
#very confused how to use this!
