...
#working with a duplicate file (same as cities30) for experimenting
...
beijingsubsetafter <- subset(duplicate, subset=c(id=="beijing" & newdate >= "2020-02-10" & newdate < as.Date("2020-02-10")+80))

print(beijingsubsetafter)
