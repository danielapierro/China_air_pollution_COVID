...
plot(all_beforelockdown2020$newdate, all_beforelockdown2020$pm25, type="p",col="red", xlim=as.Date(c("2019-10-05","2020-06-01")))
points(all_afterlockdown2020$newdate, all_afterlockdown2020$pm25,col="green") #fix date range.
