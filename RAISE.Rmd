...
all_afterlockdown2020 <- do.call("rbind", list(beijing_afterlockdown2019, ..))
...
display.brewer.all()
plot(pm25 ~ newdate, data=all_afterlockdown2020, main="Pollution After Lockdown",type = "p", pch = 16, cex=.4, col=brewer.pal(3, "YlOrRd"), xlab="Date", ylab="PM 2.5") 
...
g <- ggplot(all_afterlockdown2020, aes(newdate, pm25), color="firebrick")
g

#measure of coal plants vs. hydroelectric.
#coastal vs inland
